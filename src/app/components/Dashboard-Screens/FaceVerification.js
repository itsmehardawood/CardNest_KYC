    ...
    <div className="p-6 bg-black min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">Manage and review face verification records</p>
        </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <p className="text-gray-400 text-sm">Verification Score</p>
                    <p className="text-white font-medium mt-1">{selectedRecord.verificationScore}</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-gray-400 text-sm">Match Confidence</p>
                    <p className="text-white font-medium mt-1">{selectedRecord.matchConfidence}</p>
                  </div>
                  <div>
                    <p className="text-gray-400 text-sm">Image Quality</p>
                    <p className="text-white font-medium mt-1">{selectedRecord.imageQuality}</p>
                  </div>
                  <div>
                    <p className="text-gray-400 text-sm">Liveness Check</p>
                    <p className={`font-medium mt-1 ${selectedRecord.livenessCheck === 'Passed' ? 'text-green-500' : selectedRecord.livenessCheck === 'Failed' ? 'text-red-500' : 'text-yellow-500'}`}>
                      {selectedRecord.livenessCheck}
                    </p>
                  </div>
                </div>
              </div>
