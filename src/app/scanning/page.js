...
//     right: 'pending', // 'pending', 'active', 'completed', 'failed'
//     left: 'pending',
//     up: 'pending',
//     down: 'pending'
//   });
...
//     // Mark current direction as active
//     setDirectionStatus(prev => ({
//       ...prev,
//       [direction]: 'active'
//     }));
...
//         // Mark direction as completed (green)
//         setDirectionStatus(prev => ({
//           ...prev,
//           [direction]: 'completed'
//         }));
...
// We are required to verify your face in real time to help complete your identification process.              </p>
//             </div>
...
//                   <span>Hold each position until the indicator turns green</span>
//                 </li>
//               </ul>
//             </div>
...
//             <p className="text-red-200 text-xl mb-4">Get Ready!</p>
//             <div className="w-40 h-40 rounded-full bg-black border-4 border-red-500 flex items-center justify-center mx-auto animate-pulse">
...
//           {/* Direction indicators at top */}
//           {!isProcessing && (
//             <div className="mb-4 w-full max-w-sm">
//               <div className="grid grid-cols-4 gap-2">
//                 {movements.map((movement, idx) => {
//                   const status = directionStatus[movement.direction];
//                   const bgColor = status === 'completed' ? 'bg-green-500' : 
//                                   status === 'active' ? 'bg-yellow-500 animate-pulse' : 
//                                   'bg-gray-700';
//                   const borderStyle = status === 'active' ? 'border-2 border-yellow-300 shadow-lg shadow-yellow-500/50' : 
//                                       status === 'completed' ? 'border-2 border-green-300' : 
//                                       'border border-gray-600';
//                   return (
//                     <div 
//                       key={idx} 
//                       className={`${bgColor} ${borderStyle} rounded-lg p-2 text-center transition-all duration-300`}
//                     >
...
//                       </div>
//                       {status === 'completed' && (
//                         <div className="text-green-200 text-xs">✓</div>
//                       )}
//                     </div>
//                   );
//                 })}
...
//           {/* Current instruction with highlighted border */}
//           <div className="mb-4 text-center">
//             {!isProcessing ? (
//               <div className="bg-black/60 border-2 border-yellow-400 rounded-xl px-6 py-4 shadow-lg shadow-yellow-500/30">
...
//                   <div
//                     className="bg-gradient-to-r from-yellow-400 to-green-400 h-2 rounded-full transition-all duration-100"
...
//           {/* Video with larger face oval and direction indicators */}
...
//             {/* Face oval overlay with direction indicators */}
//             <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
//               {/* Direction indicator arrows around oval */}
//               {/* Right indicator */}
//               <div 
//                 className={`absolute right-2 top-1/2 -translate-y-1/2 w-8 h-16 rounded-full flex items-center justify-center transition-all duration-300 ${
//                   directionStatus.right === 'completed' ? 'bg-green-500/80' : 
//                   directionStatus.right === 'active' ? 'bg-yellow-500/80 animate-pulse' : 
//                   'bg-gray-600/50'
//                 }`}
//               >
...
//               {/* Left indicator */}
//               <div 
//                 className={`absolute left-2 top-1/2 -translate-y-1/2 w-8 h-16 rounded-full flex items-center justify-center transition-all duration-300 ${
//                   directionStatus.left === 'completed' ? 'bg-green-500/80' : 
//                   directionStatus.left === 'active' ? 'bg-yellow-500/80 animate-pulse' : 
//                   'bg-gray-600/50'
//                 }`}
//               >
//                 <span className="text-white text-lg">←</span>
...
//               {/* Up indicator */}
//               <div 
//                 className={`absolute top-2 left-1/2 -translate-x-1/2 w-16 h-8 rounded-full flex items-center justify-center transition-all duration-300 ${
//                   directionStatus.up === 'completed' ? 'bg-green-500/80' : 
//                   directionStatus.up === 'active' ? 'bg-yellow-500/80 animate-pulse' : 
//                   'bg-gray-600/50'
//                 }`}
//               >
//                 <span className="text-white text-lg">↑</span>
...
//               {/* Down indicator */}
//               <div 
//                 className={`absolute bottom-2 left-1/2 -translate-x-1/2 w-16 h-8 rounded-full flex items-center justify-center transition-all duration-300 ${
//                   directionStatus.down === 'completed' ? 'bg-green-500/80' : 
//                   directionStatus.down === 'active' ? 'bg-yellow-500/80 animate-pulse' : 
//                   'bg-gray-600/50'
//                 }`}
//               >
//                 <span className="text-white text-lg">↓</span>
...
//               {/* Main face oval - larger size */}
//               <div
//                 className={`border-4 transition-all duration-500 ${
//                   Object.values(directionStatus).every(s => s === 'completed') ? 'border-green-400' :
//                   Object.values(directionStatus).some(s => s === 'active') ? 'border-yellow-400' :
//                   'border-white border-dotted'
//                 }`}
//                 style={{
//                   width: '75%',
//                   height: '80%',
